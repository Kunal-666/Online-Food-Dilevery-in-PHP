        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="partials/_manageCart.php" method="post">
                    ...
                    <div class="form-group">
                        <b><label for="password">Payment Mode</label></b>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="mode" value="0" id="flexRadioDefault1" checked>
                            <label class="form-check-label" for="flexRadioDefault1">
                                Cash On Delivery
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="mode" value="1" id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Online Payment
                            </label>
                        </div>
