...
<body>
    ...
    ?>
        ...
        <div class="row" style="text-align: center;">
            <div class="col">
                <!-- <h1>1</h1> -->
                <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;border-radius: 40px;margin: 0 auto;">
                    <div class="user-info">
                        <img class="rounded-circle mb-3 bg-dark" src="img/person-<?php echo $userId; ?>.jpg" onError="this.src = 'img/profilePic.jpg'" style="width:150px;height:150px;padding:1px;">
                        ...
                        <ul class="meta list list-unstyled" style="text-align:center;">
                            <li class="username my-2"><a href="viewProfile.php">@
                                    <?php echo $username ?>
                                </a></li>
                            <li class="name">
            ...
            <div class="col">
                ...
                <div class="content-panel " style="justify-content: center;">
                    <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 40px;background-color: aliceblue;">
                        <h2 class="title text-center">Profile<span class="pro-label label label-warning"> (
                                <?php echo $userType ?>)
                            </span></h2>
